...
**Mavzu**: _Qt visual dasturlash muhitida saralash algoritmlari_

**Reja:** 
- Saralash algoritmlarning turlari. 
- Qt muhitida saralash algoritmlari. 
- Natija va tahlil. 
- Xulosa. 
...
Biz dasturimizda 6 ta saralash usulidan foydalanamiz: 
...
// bubbleSort - pufakchali saralash algoritmi
...
// merge - mergeSort algoritmini qism dasturi
...
// selectionSort - tanlash orqali saralash algoritmi
...
// insertionSort -  saralash algoritmi
...
void MainWindow::on_pushButton_clicked()
{
    ...
    ui->label_4->setText(QString::number(ms)+" milliseconds");
}
...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    qint64 ms = t_start.msecsTo(t_end);
    ui->label_5->setText(QString::number(ms)+" milliseconds");
}
...
void MainWindow::on_pushButton_3_clicked()
{
    ...
    qint64 ms = t_start.msecsTo(t_end);
    ui->label_6->setText(QString::number(ms)+" milliseconds");
}
...
void MainWindow::on_pushButton_7_clicked()
{
    ...
    qint64 ms = t_start.msecsTo(t_end);
    ui->label_8->setText(QString::number(ms)+" milliseconds");
}
...
void MainWindow::on_pushButton_8_clicked()
{
    ...
    qint64 ms = t_start.msecsTo(t_end);
    ui->label_10->setText(QString::number(ms)+" milliseconds");
}
...
void MainWindow::on_pushButton_10_clicked()
{
    ...
    qint64 ms = t_start.msecsTo(t_end);
    ui->label_12->setText(QString::number(ms)+" milliseconds");
}
```
...
```c++
QDateTime t_start=QDateTime::currentDateTime(); //saralash boshlanmasdan oldingi vaqt
QDateTime t_end;

// Saralash algoritmi

t_end=QDateTime::currentDateTime(); //saralash tugagandan keying vaqtni oluvchi kod

qint64 ms = t_start.msecsTo(t_end); // ikkala vaqtni orasidagi farqni millisekundlarda olamiz.
